...
namespace Com.Lab5e.User.Model
{
    ...
    /// AnAPIToken
    /// </summary>
    [DataContract(Name = "An_API_token")]
    public partial class AnAPIToken : IEquatable<AnAPIToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnAPIToken" /> class.
        /// </summary>
        ...
        public AnAPIToken(string resource = default(string), bool write = default(bool), Dictionary<string, string> tags = default(Dictionary<string, string>), string lastUse = default(string), string uses = default(string))
        {
        ...
        {
            return this.Equals(input as AnAPIToken);
        }

        /// <summary>
        /// Returns true if AnAPIToken instances are equal
        /// </summary>
        /// <param name="input">Instance of AnAPIToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnAPIToken input)
        {
            if (input == null)
                return false;
