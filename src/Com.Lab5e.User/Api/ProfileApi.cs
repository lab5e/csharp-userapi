...
namespace Com.Lab5e.User.Api
{
    ...
    public interface IProfileApiSync : IApiAccessor
    {
        ...
        ApiResponse<UserProfile> UserGetUserProfileWithHttpInfo();
    ...
    public interface IProfileApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UserProfile> UserGetUserProfileAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UserProfile>> UserGetUserProfileWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ProfileApi : IProfileApi
    {
        ...
        /// <exception cref="Com.Lab5e.User.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>UserProfile</returns>
        public UserProfile UserGetUserProfile()
        {
            Com.Lab5e.User.Client.ApiResponse<UserProfile> localVarResponse = UserGetUserProfileWithHttpInfo();
        ...
        /// <exception cref="Com.Lab5e.User.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UserProfile</returns>
        public Com.Lab5e.User.Client.ApiResponse<UserProfile> UserGetUserProfileWithHttpInfo()
        {
            ...
            {
                Exception _exception = this.ExceptionFactory("UserGetUserProfile", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserProfile</returns>
        public async System.Threading.Tasks.Task<UserProfile> UserGetUserProfileAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Lab5e.User.Client.ApiResponse<UserProfile> localVarResponse = await UserGetUserProfileWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserProfile)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.User.Client.ApiResponse<UserProfile>> UserGetUserProfileWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
