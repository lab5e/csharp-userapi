...
namespace Com.Lab5e.User.Api
{
    ...
    public interface ITeamsApiSync : IApiAccessor
    {
        ...
        ApiResponse<DeleteInviteResponse> UserDeleteInviteWithHttpInfo(string teamId, string code);
        /// <summary>
        /// Remove member
        /// </summary>
        /// <remarks>
    ...
    public interface ITeamsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DeleteInviteResponse> UserDeleteInviteAsync(string teamId, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DeleteInviteResponse>> UserDeleteInviteWithHttpInfoAsync(string teamId, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove member
        /// </summary>
        /// <remarks>
    ...
    public partial class TeamsApi : ITeamsApi
    {
        ...
        /// <param name="code">The invite code.</param>
        /// <returns>DeleteInviteResponse</returns>
        public DeleteInviteResponse UserDeleteInvite(string teamId, string code)
        {
            Com.Lab5e.User.Client.ApiResponse<DeleteInviteResponse> localVarResponse = UserDeleteInviteWithHttpInfo(teamId, code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="code">The invite code.</param>
        /// <returns>ApiResponse of DeleteInviteResponse</returns>
        public Com.Lab5e.User.Client.ApiResponse<DeleteInviteResponse> UserDeleteInviteWithHttpInfo(string teamId, string code)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeleteInviteResponse</returns>
        public async System.Threading.Tasks.Task<DeleteInviteResponse> UserDeleteInviteAsync(string teamId, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Lab5e.User.Client.ApiResponse<DeleteInviteResponse> localVarResponse = await UserDeleteInviteWithHttpInfoAsync(teamId, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteInviteResponse)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.User.Client.ApiResponse<DeleteInviteResponse>> UserDeleteInviteWithHttpInfoAsync(string teamId, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'teamId' is set
            if (teamId == null)
                throw new Com.Lab5e.User.Client.ApiException(400, "Missing required parameter 'teamId' when calling TeamsApi->UserDeleteInvite");
