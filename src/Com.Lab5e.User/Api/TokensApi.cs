...
namespace Com.Lab5e.User.Api
{
    ...
    public interface ITokensApiSync : IApiAccessor
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Token</returns>
        ApiResponse<Token> UpdateTokenWithHttpInfo(string token, AnAPIToken body);
    ...
    public interface ITokensApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Token</returns>
        System.Threading.Tasks.Task<Token> UpdateTokenAsync(string token, AnAPIToken body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Token)</returns>
        System.Threading.Tasks.Task<ApiResponse<Token>> UpdateTokenWithHttpInfoAsync(string token, AnAPIToken body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TokensApi : ITokensApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>Token</returns>
        public Token UpdateToken(string token, AnAPIToken body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Token</returns>
        public Com.Lab5e.User.Client.ApiResponse<Token> UpdateTokenWithHttpInfo(string token, AnAPIToken body)
        {
            // verify the required parameter 'token' is set
            if (token == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Token</returns>
        public async System.Threading.Tasks.Task<Token> UpdateTokenAsync(string token, AnAPIToken body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Token)</returns>
        public async System.Threading.Tasks.Task<Com.Lab5e.User.Client.ApiResponse<Token>> UpdateTokenWithHttpInfoAsync(string token, AnAPIToken body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'token' is set
            if (token == null)
                throw new Com.Lab5e.User.Client.ApiException(400, "Missing required parameter 'token' when calling TokensApi->UpdateToken");
