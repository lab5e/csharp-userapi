...
namespace Com.Lab5e.User.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/1.3.13/csharp";
            BasePath = "https://api.lab5e.com";
        ...
        public Configuration(
            ...
            string basePath = "https://api.lab5e.com") : this()
        {
        ...
        {
            String report = "C# SDK (Com.Lab5e.User) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.3.13 bordering-jerilyn\n";
            report += "    SDK Package Version: 1.3.13\n";
